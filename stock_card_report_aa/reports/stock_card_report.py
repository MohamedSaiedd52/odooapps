...
class StockCardReport(models.TransientModel):
    ...
    def print_report(self, mode):
        ...
        action = (
            report_type == "xlsx"
            and self.env.ref("stock_card_report_aa.action_stock_card_report_aa_xlsx")
            or self.env.ref("stock_card_report_aa.action_stock_card_report_aa_pdf")
        )
    ...
    def _get_html(self):
        ...
        if report:
            ...
            result["html"] = self.env["ir.qweb"]._render(
                "stock_card_report_aa.report_stock_card_report_aa_html", rcontext
            )
        return result
