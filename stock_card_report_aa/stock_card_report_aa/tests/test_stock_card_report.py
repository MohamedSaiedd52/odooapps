...
class TestStockCard(common.TransactionCase):
    ...
    def _getQwebReportName(self):
        return "stock_card_report_aa.report_stock_card_report_aa_pdf"

    def _getXlsxReportName(self):
        return "stock_card_report_aa.report_stock_card_report_aa_xlsx"

    def _getXlsxReportActionName(self):
        return "stock_card_report_aa.action_report_stock_card_report_aa_xlsx"
