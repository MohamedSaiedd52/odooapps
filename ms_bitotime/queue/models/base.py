...
class Base(models.AbstractModel):
    ...
    def _patch_method(cls, name, method):
        ...
        # propagate api decorators from origin to method
        # (api.propagate was removed in Odoo 19, copy the attributes inline)
        for attr in ("_returns", "_api", "_api_model", "_api_private"):
