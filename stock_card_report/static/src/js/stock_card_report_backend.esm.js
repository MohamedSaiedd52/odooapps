    ...
    setup() {
        ...
        useEffect(
            (el) => {
                ...
                container.querySelector('.o_stock_card_reports_print')?.addEventListener("click", () => {
                    this.print();
                });

                container.querySelector('.o_stock_card_reports_export')?.addEventListener("click", () => {
                    this.export();
                });
...
registry.category("actions").add("stock_card_report_backend", ReportBackend);
