...
class Base(models.AbstractModel):
    ...
    def _get_view(self, view_id=None, view_type='form', **options):
        ...
        if view_type == 'form':
            ...
            if hide_chatter:
                # 18.0 renders the chatter from a <chatter/> tag; the legacy
                # <div class="oe_chatter"> is still around in older third-party
                # views, so both are removed.
                for node in arch.xpath("//chatter | //div[@class='oe_chatter']"):
